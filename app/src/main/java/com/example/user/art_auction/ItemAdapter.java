...
//        super(context, R.layout.hp_row, foods);
//    }
//
//    @Override
...
//        View itemView = myCustomInflater.inflate(R.layout.item_pics_row, parent, false);
//        // get references.
...
////        TextView itemText = (TextView) item_pics_row.findViewById(R.id.item_text);
////        Button b1 = (Button) item_pics_row.findViewById(R.id.enter_btn);
////        Button b2 = (Button) item_pics_row.findViewById(R.id.sign_up_btn);
//        ImageView auctionImage = (ImageView) itemView.findViewById(R.id.my_item_image);
//
////        EditText description = (EditText) item_pics_row.findViewById(R.id.item_description);
//
