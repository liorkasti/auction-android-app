...
public class AuctionItemBid implements Serializable {
	...
	private Date bidTs;
	private AuctionItemBid auctionItemBid;
	...
	public AuctionItemBid getAuctionItemBid() {
		return auctionItemBid;
	}


	public void setAuctionItemBid(AuctionItemBid auctionItemBid) {
		this.auctionItemBid  = auctionItemBid;
	}
